...
//////////////////////////////////////////////////////////////////////////////
// tourney_ga_search uses implements ga_search using TournamentDeme class.
// This changes the selection of parents to be made by a tournament.
Cities::permutation_t
tourney_ga_search(const Cities& cities,
          unsigned iters,
          unsigned pop_size,
          double mutation_rate)
{
...
//  const auto best_ordering = ga_search(cities, NUM_ITER, pop_size, mut_rate);
  const auto best_ordering = tourney_ga_search(cities, NUM_ITER, pop_size, mut_rate);
